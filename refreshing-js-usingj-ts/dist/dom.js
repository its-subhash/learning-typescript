...
subButtonElement === null || subButtonElement === void 0 ? void 0 : subButtonElement.addEventListener("click", () => {
...
btnA === null || btnA === void 0 ? void 0 : btnA.addEventListener("click", () => console.log("9a"));
btnB === null || btnB === void 0 ? void 0 : btnB.addEventListener("click", () => (btnB.innerText = "9b done!"));
const showMessage = (elment, message) => {
    elment.innerText = message;
};
headsElement === null || headsElement === void 0 ? void 0 : headsElement.addEventListener("click", () => showMessage(flipMsgElement, "You chose: heads!"));
tailsElement === null || tailsElement === void 0 ? void 0 : tailsElement.addEventListener("click", () => showMessage(flipMsgElement, "You chose: tails!"));
nameBtnElement === null || nameBtnElement === void 0 ? void 0 : nameBtnElement.addEventListener('click', () => {
    showMessage(nameMsgElement, `Your name is: ${nameInputElement.value}`);
});
nameInputElement === null || nameInputElement === void 0 ? void 0 : nameInputElement.addEventListener('keydown', (event) => {
    // if (event.key === "Enter"){
    //     showMessage(nameMsgElement, `Your name is: ${nameInputElement.value}`)
    // }
