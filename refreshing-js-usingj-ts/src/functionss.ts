...
const convertTempreture =(degree:number, unit:string):number =>{
...
const convertLength =(length:number, from:string, to:string):string=>{
...
const convertLengthUpdate = (length:number, from:string, to:string) => {
    from = from.toUpperCase();
    to = to.toUpperCase();
    if (from === "KM" && to === "MILES"){
...
const convertLengthUpdate2 = (length:number, from:string, to:string):string => {
    from = from.toUpperCase();
    to = to.toUpperCase();
